...
a persistence unit "saleforcePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "saleforce/pom.xml":
...
artifacts ("saleforce-ejb.jar" and "saleforce-web.war") are already built. You can build
